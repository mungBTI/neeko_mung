...
const TestHome: React.FC<TestHomeProps> = ({
  ...
  const testContent = testList.find((test) => test.key === testType);
    ...
    <div className="bg-cottonBlue w-full flex flex-col items-center p-4 justify-around h-full">
      <div id="article_body" className="flex flex-col">
        <Image
          ...
          height={300}
        ></Image>
        <button className="bg-[#0077B6] text-white py-2 px-4 text-xl my-8 mx-auto text-center rounded-full mb-0">
          테스트 시작하기
        </button>
